...
func ExampleBool() {
	...
	fmt.Printf("Zero pointer value: %T %v\n", s.Pointer, s.Pointer)

	s.Pointer = pointer.Bool(true)
	fmt.Printf("The value set by the library: %T %v\n", s.Pointer, *s.Pointer)

	s.Pointer = &[]bool{true}[0]
	fmt.Printf("The value set in elegant way: %T %v\n", s.Pointer, *s.Pointer)
...
// 	fmt.Printf("The value set by the library: %T %3[2]d %[2]q", s.Pointer, *s.Pointer)

// 	s.Pointer = &[]rune{99}[0]
// 	fmt.Printf("The value set in elegant way: %T %3[2]d %[2]q", s.Pointer, *s.Pointer)
